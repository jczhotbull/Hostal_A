...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>                               
            ...
            /&nbsp;&nbsp;<b>                               
              ...
              ?>              
            </b> - <?php echo $row_the_currencys_second['symbol_currency']; ?> &nbsp;&nbsp;
            /&nbsp;&nbsp; <b>                                
              <?php              
              if ($totalRows_room_pp != '0') {
              ...
              ?>              
            </b> - <?php echo $row_the_currencys_third['symbol_currency']; ?>  <br>


            - Bed for <b><?php echo $dateDiff; ?></b> Night(s):   
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>                               
            ...
            /&nbsp;&nbsp; <b>                                
              ...
              ?>              
            </b> - <?php echo $row_the_currencys_third['symbol_currency']; ?> <br><br>
            - Room per <b>1</b> Night: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>
            ...
            - Room for <b><?php echo $dateDiff; ?></b> Night(s): &nbsp;&nbsp;<b>
            ...
            /&nbsp;&nbsp; <b>                                
              ...
              ?></b>  - <?php echo $row_the_currencys_third['symbol_currency']; ?>            


</div>


<h4 class="glowwhite mt-4" <?php if ( $totalRows_rooms_few =='0' OR $alerta_principal =='0'  ){?>style="display:none"<?php } ?> >Select from a Room:</h4>
...
<a href="f_check_in.php?ttitulo=<?php echo $name_bed_b; ?>&rr=<?php echo $date_range; ?>&id_r=<?php echo $id_room_f; ?>&id_rb=<?php echo $id_bed_f; ?>"   
...
<?php if ( $conteo == $totalRows_rooms_reveal_name_tipes ){?>style="display:none"<?php } ?> >

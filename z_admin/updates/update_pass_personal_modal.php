...
<div class="modal fade" id="password<?php echo $row_usuarios['id_per']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="form-row margencito"> 
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="editar_password_personal" class="btn btn-secondary" value="<?php echo $row_usuarios['id_per']; ?>">

...
<input type="text" maxlength="199" class="form-control " id="comentario_hospedaje" name="comentario_hospedaje" aria-label="comentario_hospedaje" aria-describedby="basic-addon1" placeholder="Observations..." required>

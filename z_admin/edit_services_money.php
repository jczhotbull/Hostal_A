...
$cost_price = $_POST['cost_price'];
    ...
    the_price, tax_services, discount_type, set_by_this_per, my_cost) 
...
<i class="fa-solid fa-boxes-packing fa-lg "></i> &nbsp; &nbsp;  <i> <b><?php echo $ttitulo ?></b> Services expressed in <?php echo $row_the_currencys_prim['symbol_currency']; ?>.</i>
                </div> 
...
<table class="table table-bordered" style="text-align: center; margin-top: 50%;" id="dataTable" width="100%" cellspacing="0" >
  ...
  <?php do{?>  <!-- va a generarme tantas filas como datos tenga esta BD -->          
   ...
   $id_del_servicio_para_precios = $row_services_serv_count['id_services'];
    ...
    ?></span></b> <br> For <span style="color:green;"><b><?php $kind_kind = $row_services_serv_count['sale_kind'];
    ...
    ?>
       <span style="font-size: 12px;">      <b>Current Sale Price:</b> <?php
    ...
    <span data-toggle="tooltip" data-placement="top" title="Delete Current"" >
     ...
     data-target="#delete_service_price<?php echo $row_services_serv_current['id_services_prices']; ?>"
      ...
      <?php include("deletes/delete_service_price_modal.php"); ?>       
            ...
            <span style="font-size: 12px;">      <b>Cost:</b> <?php
             
             if ($totalRows_services_serv_current >='1') {


                echo $row_services_serv_current['my_cost'];
             }
            ...
            <span style="font-size: 12px; color:green;">      <b>Profits:</b> <?php
             
             if ($totalRows_services_serv_current >='1') {

             $ganancia_neta = ($row_services_serv_current['the_price'] - $row_services_serv_current['my_cost'] );

             $ganancia_en_porcentaje = ($ganancia_neta/$row_services_serv_current['the_price'])*100;

             $english_sub_ganancia = number_format($ganancia_en_porcentaje, 2, '.', '');

                echo $english_sub_ganancia;
             }
...
<div class="input-group input-group-sm col-sm-12 col-md-12 col-lg-12">
            ...
            id="cost_price" name="cost_price" step="0.01" min="0.00" placeholder="Cost..."
            aria-label="cost_price" aria-describedby="basic-addon1" required>

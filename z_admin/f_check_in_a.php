...
<h4 class="glowwhite mt-4" <?php if ( $row_roomsMM->total_roomsMM =='0'  ){?>style="display:none"<?php } ?> >Select Room By Type:</h4>
...
href="f_check_room_bed.php?idtabla=<?php  echo $este_id_kind; ?>&ttitulo=<?php  echo $mi_name_kind; ?>">  

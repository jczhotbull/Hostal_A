...
?>
              ...
              <div class="form-row" <?php if ( $totalRows_the_currencys_prim =='0' ){?>style="display:none"<?php } ?> > 
                ...
                <div class="alert col-md-3 col-lg-3 alert-primary" role="alert">
                    <i class="fa-solid fa-cash-register fa-lg "></i> &nbsp; &nbsp; Beds Prices
                </div>
...
<h4 class="glowwhite mt-4" <?php if ( $row_roomsMM->total_roomsMM =='0' ){?>style="display:none"<?php } ?> >Set By Bed Types:</h4>
...
echo $row_rooms_reveal_name_tipes['name_room_kind']; ?> </b> <?php echo $discc; ?><?php echo $symbc; ?> <?php echo $off; ?>
             ...
             Prior:&nbsp;&nbsp;<b>
              ...
              if ($totalRows_room_pp_dos != '0') {
                echo $row_room_pp_dos['name_prices_beds'];
              }
           ...
           href="edit_bed_money.php?idtabla=<?php  echo $este_id_kind; ?>&ttitulo=<?php  echo $mi_name_kind; ?>&ttitulo=<?php  echo $mi_name_kind; ?>">
